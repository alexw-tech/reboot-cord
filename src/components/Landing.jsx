  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#1e140a] text-[#f0f0f0]">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="bg-[#3b3b3b] border-4 border-black text-white p-0 overflow-hidden max-w-sm">
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-4">
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase text-[#7a7a7a]">Username</label>
                <input 
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase text-[#7a7a7a]">Password</label>
                <input 
                  type="password"
                  className="mc-input w-full" 
                  value={password}
            ...
            <button 
              ...
              className="mc-btn w-full bg-[#54a332] font-black uppercase py-4"
            >
            ...
            <div className="text-center">
              <button 
                ...
                className="text-[10px] font-bold uppercase text-[#bcbcbc] hover:text-white"
              >
